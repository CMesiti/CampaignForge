...
def prompt_with_context(request: ModelRequest):
    ...
    current_app.logger.info(f"PROMP_WITH_CONTEXT - {last_query} - {retrieved_docs}")

    g.docs = retrieved_docs
    system_message = f"""
